...
class ReportOverallSummary(models.TransientModel):
    _name = "report.overall.summary"
    ...
    medicine_line_ids = fields.One2many('report.medicine.lines', 'report_id', string='Medicines')
